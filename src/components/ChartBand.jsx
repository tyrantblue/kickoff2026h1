...
export function ChartBand() {
  return (
    <div className="mt-[18px] grid grid-cols-2 gap-[18px] max-[1100px]:grid-cols-1">
      <article className="rounded-lg border border-[var(--line)] bg-[var(--surface)] p-[18px] transition hover:-translate-y-1 hover:shadow-[0_16px_30px_rgba(15,23,42,0.1)]">
